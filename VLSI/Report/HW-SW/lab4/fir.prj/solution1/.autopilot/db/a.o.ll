; ModuleID = 'D:/cd/HWSW/Project/lab4/fir.prj/solution1/.autopilot/db/a.o.bc'
...
define void @fir(i16* %y, i16 signext %x) nounwind uwtable {
  ...
  %acc = alloca i38, align 4                      ; [#uses=6 type=i38*]
  ...
  %3 = load i16** %1, align 8, !dbg !37           ; [#uses=1 type=i16*] [debug line = 7:1]
  ...
  %6 = load i16* getelementptr inbounds ([58 x i16]* @fir.shift_reg, i32 0, i64 57), align 2, !dbg !48 ; [#uses=1 type=i16] [debug line = 16:3]
  %7 = sext i16 %6 to i38, !dbg !48               ; [#uses=1 type=i38] [debug line = 16:3]
  %8 = load i16* getelementptr inbounds ([59 x i16]* @fir.c, i32 0, i64 58), align 2, !dbg !48 ; [#uses=1 type=i16] [debug line = 16:3]
  %9 = sext i16 %8 to i38, !dbg !48               ; [#uses=1 type=i38] [debug line = 16:3]
  %10 = mul nsw i38 %7, %9, !dbg !48              ; [#uses=1 type=i38] [debug line = 16:3]
  store i38 %10, i38* %acc, align 4, !dbg !48     ; [debug line = 16:3]
...
; <label>:12                                      ; preds = %38, %11
  ...
  br i1 %14, label %15, label %41, !dbg !49       ; [debug line = 17:14]
...
; <label>:15                                      ; preds = %12
  ...
  %18 = sext i32 %17 to i64, !dbg !54             ; [#uses=1 type=i64] [debug line = 18:5]
  %19 = getelementptr inbounds [58 x i16]* @fir.shift_reg, i32 0, i64 %18, !dbg !54 ; [#uses=1 type=i16*] [debug line = 18:5]
  %20 = load i16* %19, align 2, !dbg !54          ; [#uses=1 type=i16] [debug line = 18:5]
  %21 = sext i16 %20 to i38, !dbg !54             ; [#uses=1 type=i38] [debug line = 18:5]
  %22 = load i32* %i, align 4, !dbg !54           ; [#uses=1 type=i32] [debug line = 18:5]
  %23 = sext i32 %22 to i64, !dbg !54             ; [#uses=1 type=i64] [debug line = 18:5]
  %24 = getelementptr inbounds [59 x i16]* @fir.c, i32 0, i64 %23, !dbg !54 ; [#uses=1 type=i16*] [debug line = 18:5]
  %25 = load i16* %24, align 2, !dbg !54          ; [#uses=1 type=i16] [debug line = 18:5]
  %26 = sext i16 %25 to i38, !dbg !54             ; [#uses=1 type=i38] [debug line = 18:5]
  %27 = mul nsw i38 %21, %26, !dbg !54            ; [#uses=1 type=i38] [debug line = 18:5]
  %28 = load i38* %acc, align 4, !dbg !54         ; [#uses=1 type=i38] [debug line = 18:5]
  %29 = add nsw i38 %28, %27, !dbg !54            ; [#uses=1 type=i38] [debug line = 18:5]
  store i38 %29, i38* %acc, align 4, !dbg !54     ; [debug line = 18:5]
  %30 = load i32* %i, align 4, !dbg !55           ; [#uses=1 type=i32] [debug line = 19:5]
  %31 = sub nsw i32 %30, 1, !dbg !55              ; [#uses=1 type=i32] [debug line = 19:5]
  %32 = sext i32 %31 to i64, !dbg !55             ; [#uses=1 type=i64] [debug line = 19:5]
  %33 = getelementptr inbounds [58 x i16]* @fir.shift_reg, i32 0, i64 %32, !dbg !55 ; [#uses=1 type=i16*] [debug line = 19:5]
  %34 = load i16* %33, align 2, !dbg !55          ; [#uses=1 type=i16] [debug line = 19:5]
  %35 = load i32* %i, align 4, !dbg !55           ; [#uses=1 type=i32] [debug line = 19:5]
  %36 = sext i32 %35 to i64, !dbg !55             ; [#uses=1 type=i64] [debug line = 19:5]
  %37 = getelementptr inbounds [58 x i16]* @fir.shift_reg, i32 0, i64 %36, !dbg !55 ; [#uses=1 type=i16*] [debug line = 19:5]
  store i16 %34, i16* %37, align 2, !dbg !55      ; [debug line = 19:5]
  ...
  br label %38, !dbg !56                          ; [debug line = 20:3]

; <label>:38                                      ; preds = %15
  %39 = load i32* %i, align 4, !dbg !57           ; [#uses=1 type=i32] [debug line = 17:27]
  %40 = add nsw i32 %39, -1, !dbg !57             ; [#uses=1 type=i32] [debug line = 17:27]
  store i32 %40, i32* %i, align 4, !dbg !57       ; [debug line = 17:27]
  br label %12, !dbg !57                          ; [debug line = 17:27]

; <label>:41                                      ; preds = %12
  %42 = load i16* %2, align 2, !dbg !58           ; [#uses=1 type=i16] [debug line = 21:3]
  %43 = sext i16 %42 to i38, !dbg !58             ; [#uses=1 type=i38] [debug line = 21:3]
  %44 = load i16* getelementptr inbounds ([59 x i16]* @fir.c, i32 0, i64 0), align 2, !dbg !58 ; [#uses=1 type=i16] [debug line = 21:3]
  %45 = sext i16 %44 to i38, !dbg !58             ; [#uses=1 type=i38] [debug line = 21:3]
  %46 = mul nsw i38 %43, %45, !dbg !58            ; [#uses=1 type=i38] [debug line = 21:3]
  %47 = load i38* %acc, align 4, !dbg !58         ; [#uses=1 type=i38] [debug line = 21:3]
  %48 = add nsw i38 %47, %46, !dbg !58            ; [#uses=1 type=i38] [debug line = 21:3]
  store i38 %48, i38* %acc, align 4, !dbg !58     ; [debug line = 21:3]
  %49 = load i16* %2, align 2, !dbg !59           ; [#uses=1 type=i16] [debug line = 22:3]
  store i16 %49, i16* getelementptr inbounds ([58 x i16]* @fir.shift_reg, i32 0, i64 0), align 2, !dbg !59 ; [debug line = 22:3]
  %50 = load i38* %acc, align 4, !dbg !60         ; [#uses=1 type=i38] [debug line = 23:3]
  %51 = ashr i38 %50, 15, !dbg !60                ; [#uses=1 type=i38] [debug line = 23:3]
  %52 = trunc i38 %51 to i16, !dbg !60            ; [#uses=1 type=i16] [debug line = 23:3]
  %53 = load i16** %1, align 8, !dbg !60          ; [#uses=1 type=i16*] [debug line = 23:3]
  store i16 %52, i16* %53, align 2, !dbg !60      ; [debug line = 23:3]
...
!0 = metadata !{i32 786449, i32 0, i32 1, metadata !"D:/cd/HWSW/Project/lab4/fir.prj/solution1/.autopilot/db/fir.pragma.2.c", metadata !"D:\5Ccd\5CHWSW\5CProject\5Clab4", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !1, metadata !3, metadata !14} ; [ DW_TAG_compile_unit ]
...
!6 = metadata !{i32 786473, metadata !"fir.c", metadata !"D:\5Ccd\5CHWSW\5CProject\5Clab4", null} ; [ DW_TAG_file_type ]
...
!43 = metadata !{i32 786468, null, metadata !"int38", null, i32 0, i64 38, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
