; ModuleID = 'D:/cd/HWSW/Project/lab4/fir.prj/solution1/.autopilot/db/a.o.2.bc'
...
define void @fir(i16* %y, i16 signext %x) nounwind uwtable {
  ...
  %shift_reg.load = load i16* getelementptr inbounds ([58 x i16]* @shift_reg, i64 0, i64 57), align 2, !dbg !47 ; [#uses=1 type=i16] [debug line = 16:3]
...
; <label>:3                                       ; preds = %1
  ...
  %tmp. = zext i6 %i.1 to i64, !dbg !57           ; [#uses=1 type=i64] [debug line = 18:5]
  %shift_reg.addr = getelementptr inbounds [58 x i16]* @shift_reg, i64 0, i64 %tmp., !dbg !57 ; [#uses=1 type=i16*] [debug line = 18:5]
  %shift_reg.load.1 = load i16* %shift_reg.addr, align 2, !dbg !57 ; [#uses=2 type=i16] [debug line = 18:5]
  %tmp.2.cast = sext i16 %shift_reg.load.1 to i32, !dbg !57 ; [#uses=1 type=i32] [debug line = 18:5]
  %tmp.6 = zext i6 %i to i64, !dbg !57            ; [#uses=2 type=i64] [debug line = 18:5]
  %c.addr = getelementptr inbounds [59 x i16]* @c, i64 0, i64 %tmp.6, !dbg !57 ; [#uses=1 type=i16*] [debug line = 18:5]
  %c.load = load i16* %c.addr, align 2, !dbg !57  ; [#uses=1 type=i16] [debug line = 18:5]
  %tmp.9.cast = sext i16 %c.load to i32, !dbg !57 ; [#uses=1 type=i32] [debug line = 18:5]
  %tmp.1 = mul i32 %tmp.9.cast, %tmp.2.cast, !dbg !57 ; [#uses=1 type=i32] [debug line = 18:5]
  %tmp.10.cast = sext i32 %tmp.1 to i37, !dbg !57 ; [#uses=1 type=i37] [debug line = 18:5]
  %acc.2 = add i37 %acc1, %tmp.10.cast, !dbg !57  ; [#uses=1 type=i37] [debug line = 18:5]
  call void @llvm.dbg.value(metadata !{i37 %acc.2}, i64 0, metadata !48), !dbg !57 ; [debug line = 18:5] [debug variable = acc]
  %shift_reg.addr.1 = getelementptr inbounds [58 x i16]* @shift_reg, i64 0, i64 %tmp.6, !dbg !58 ; [#uses=1 type=i16*] [debug line = 19:5]
...
; <label>:5                                       ; preds = %1
  ...
  store i16 %x, i16* getelementptr inbounds ([58 x i16]* @shift_reg, i64 0, i64 0), align 16, !dbg !64 ; [debug line = 22:3]
...
!7 = metadata !{i32 786449, i32 0, i32 1, metadata !"D:/cd/HWSW/Project/lab4/fir.prj/solution1/.autopilot/db/fir.pragma.2.c", metadata !"D:\5Ccd\5CHWSW\5CProject\5Clab4", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, null, null, null, metadata !8} ; [ DW_TAG_compile_unit ]
...
!12 = metadata !{i32 786473, metadata !"fir.c", metadata !"D:\5Ccd\5CHWSW\5CProject\5Clab4", null} ; [ DW_TAG_file_type ]
...
!51 = metadata !{i32 786468, null, metadata !"int38", null, i32 0, i64 38, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
