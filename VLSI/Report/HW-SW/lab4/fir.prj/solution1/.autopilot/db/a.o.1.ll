; ModuleID = 'D:/cd/HWSW/Project/lab4/fir.prj/solution1/.autopilot/db/a.g.1.bc'
...
define void @fir(i16* %y, i16 signext %x) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([7 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !37 ; [debug line = 7:1]
  call void (...)* @_ssdm_op_SpecInterface(i16* %y, i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([7 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !37 ; [debug line = 7:1]
  %tmp = sext i16 %x to i32, !dbg !37             ; [#uses=1 type=i32] [debug line = 7:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %tmp, i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([7 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !37 ; [debug line = 7:1]
  %shift_reg.load = load i16* getelementptr inbounds ([58 x i16]* @shift_reg, i64 0, i64 57), align 2, !dbg !39 ; [#uses=2 type=i16] [debug line = 16:3]
...
; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([5 x i8]* @.str3, i64 0, i64 0)), !dbg !46 ; [debug line = 17:33]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([5 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !46 ; [#uses=1 type=i32] [debug line = 17:33]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !48 ; [debug line = 18:1]
  %i.1 = add nsw i32 %i, -1, !dbg !49             ; [#uses=2 type=i32] [debug line = 18:5]
  %tmp.10 = sext i32 %i.1 to i64, !dbg !49        ; [#uses=1 type=i64] [debug line = 18:5]
  %shift_reg.addr = getelementptr inbounds [58 x i16]* @shift_reg, i64 0, i64 %tmp.10, !dbg !49 ; [#uses=1 type=i16*] [debug line = 18:5]
  ...
  %tmp.11 = sext i16 %shift_reg.load.1 to i38, !dbg !49 ; [#uses=1 type=i38] [debug line = 18:5]
  %tmp.12 = sext i32 %i to i64, !dbg !49          ; [#uses=2 type=i64] [debug line = 18:5]
  %c.addr = getelementptr inbounds [59 x i16]* @c, i64 0, i64 %tmp.12, !dbg !49 ; [#uses=1 type=i16*] [debug line = 18:5]
  ...
  %tmp.13 = sext i16 %c.load to i38, !dbg !49     ; [#uses=1 type=i38] [debug line = 18:5]
  %tmp.14 = mul nsw i38 %tmp.13, %tmp.11, !dbg !49 ; [#uses=1 type=i38] [debug line = 18:5]
  %acc.3 = add nsw i38 %tmp.14, %acc1, !dbg !49   ; [#uses=1 type=i38] [debug line = 18:5]
  call void @llvm.dbg.value(metadata !{i38 %acc.3}, i64 0, metadata !40), !dbg !49 ; [debug line = 18:5] [debug variable = acc]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %shift_reg.load.1) nounwind
  %shift_reg.addr.1 = getelementptr inbounds [58 x i16]* @shift_reg, i64 0, i64 %tmp.12, !dbg !50 ; [#uses=1 type=i16*] [debug line = 19:5]
  store i16 %shift_reg.load.1, i16* %shift_reg.addr.1, align 2, !dbg !50 ; [debug line = 19:5]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([5 x i8]* @.str3, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !51 ; [#uses=0 type=i32] [debug line = 20:3]
...
; <label>:3                                       ; preds = %1
  ...
  store i16 %x, i16* getelementptr inbounds ([58 x i16]* @shift_reg, i64 0, i64 0), align 16, !dbg !56 ; [debug line = 22:3]
