; ModuleID = 'D:/cd/HWSW/Project/lab4/fir.prj/solution1/.autopilot/db/a.o.3.bc'
...
define void @fir(i16* %y, i16 signext %x) nounwind uwtable {
  ...
  %shift_reg_load = load i16* getelementptr inbounds ([58 x i16]* @shift_reg, i64 0, i64 57), align 2, !dbg !34 ; [#uses=1 type=i16] [debug line = 16:3]
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_s = zext i6 %i_1 to i64, !dbg !44          ; [#uses=1 type=i64] [debug line = 18:5]
  %shift_reg_addr = getelementptr inbounds [58 x i16]* @shift_reg, i64 0, i64 %tmp_s, !dbg !44 ; [#uses=1 type=i16*] [debug line = 18:5]
  %shift_reg_load_1 = load i16* %shift_reg_addr, align 2, !dbg !44 ; [#uses=2 type=i16] [debug line = 18:5]
  %tmp_2_cast = sext i16 %shift_reg_load_1 to i32, !dbg !44 ; [#uses=1 type=i32] [debug line = 18:5]
  %tmp_6 = zext i6 %i to i64, !dbg !44            ; [#uses=2 type=i64] [debug line = 18:5]
  %c_addr = getelementptr inbounds [59 x i16]* @c, i64 0, i64 %tmp_6, !dbg !44 ; [#uses=1 type=i16*] [debug line = 18:5]
  %c_load = load i16* %c_addr, align 2, !dbg !44  ; [#uses=1 type=i16] [debug line = 18:5]
  %tmp_9_cast = sext i16 %c_load to i32, !dbg !44 ; [#uses=1 type=i32] [debug line = 18:5]
  %tmp_1 = mul i32 %tmp_2_cast, %tmp_9_cast, !dbg !44 ; [#uses=1 type=i32] [debug line = 18:5]
  %tmp_10_cast = sext i32 %tmp_1 to i37, !dbg !44 ; [#uses=1 type=i37] [debug line = 18:5]
  %acc_2 = add i37 %tmp_10_cast, %acc1, !dbg !44  ; [#uses=1 type=i37] [debug line = 18:5]
  call void @llvm.dbg.value(metadata !{i37 %acc_2}, i64 0, metadata !35), !dbg !44 ; [debug line = 18:5] [debug variable = acc]
  %shift_reg_addr_1 = getelementptr inbounds [58 x i16]* @shift_reg, i64 0, i64 %tmp_6, !dbg !45 ; [#uses=1 type=i16*] [debug line = 19:5]
...
; <label>:3                                       ; preds = %1
  %tmp_2 = trunc i37 %acc1 to i31, !dbg !39       ; [#uses=1 type=i31] [debug line = 17:14]
  ...
  %acc_1 = add i31 %tmp_5_cast, %tmp_2, !dbg !50  ; [#uses=1 type=i31] [debug line = 21:3]
  call void @llvm.dbg.value(metadata !{i31 %acc_1}, i64 0, metadata !35), !dbg !50 ; [debug line = 21:3] [debug variable = acc]
  store i16 %x_read, i16* getelementptr inbounds ([58 x i16]* @shift_reg, i64 0, i64 0), align 16, !dbg !51 ; [debug line = 22:3]
...
!21 = metadata !{i32 786473, metadata !"fir.c", metadata !"D:\5Ccd\5CHWSW\5CProject\5Clab4", null} ; [ DW_TAG_file_type ]
...
!38 = metadata !{i32 786468, null, metadata !"int38", null, i32 0, i64 38, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
