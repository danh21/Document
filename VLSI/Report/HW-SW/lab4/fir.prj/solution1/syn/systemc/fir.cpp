...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    fir_mul_mul_16s_1bkb_U1->din0(reg_138);
    fir_mul_mul_16s_1bkb_U1->din1(acc_fu_195_p1);
    fir_mul_mul_16s_1bkb_U1->dout(acc_fu_195_p2);
    fir_mac_muladd_16cud_U2 = new fir_mac_muladd_16cud<1,1,16,16,37,37>("fir_mac_muladd_16cud_U2");
    fir_mac_muladd_16cud_U2->din0(reg_138);
    fir_mac_muladd_16cud_U2->din1(c_load_reg_258);
    fir_mac_muladd_16cud_U2->din2(acc1_reg_117);
    fir_mac_muladd_16cud_U2->dout(grp_fu_201_p3);
    fir_mac_muladd_10dEe_U3 = new fir_mac_muladd_10dEe<1,1,10,16,31,31>("fir_mac_muladd_10dEe_U3");
    fir_mac_muladd_10dEe_U3->din0(grp_fu_209_p0);
    fir_mac_muladd_10dEe_U3->din1(x_read_reg_223);
    fir_mac_muladd_10dEe_U3->din2(grp_fu_209_p2);
    fir_mac_muladd_10dEe_U3->dout(grp_fu_209_p3);

    SC_METHOD(thread_ap_clk_no_reset_);
    dont_initialize();
    sensitive << ( ap_clk.pos() );

    SC_METHOD(thread_acc_cast_fu_146_p1);
    sensitive << ( acc_reg_218 );

    SC_METHOD(thread_acc_fu_195_p1);
    ...
    SC_METHOD(thread_ap_phi_mux_i_phi_fu_131_p4);
    sensitive << ( i_reg_127 );
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( ap_enable_reg_pp0_iter1 );
    sensitive << ( tmp_3_reg_234 );
    sensitive << ( i_1_reg_238 );
    ...
    sensitive << ( acc1_reg_117 );
    sensitive << ( ap_CS_fsm_state8 );

    SC_METHOD(thread_i_1_fu_155_p2);
    sensitive << ( ap_phi_mux_i_phi_fu_131_p4 );
    ...
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( ap_block_pp0_stage0 );
    sensitive << ( tmp_s_fu_161_p1 );

    SC_METHOD(thread_shift_reg_address1);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( ap_enable_reg_pp0_iter1 );
    sensitive << ( tmp_6_reg_248 );
    sensitive << ( ap_block_pp0_stage0 );
    sensitive << ( ap_CS_fsm_state8 );
    ...
    SC_METHOD(thread_tmp_3_fu_149_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( ap_phi_mux_i_phi_fu_131_p4 );
    ...
    SC_METHOD(thread_tmp_s_fu_161_p1);
    sensitive << ( i_1_fu_155_p2 );

    SC_METHOD(thread_y);
    sensitive << ( ap_CS_fsm_state8 );
    sensitive << ( grp_fu_209_p3 );
    ...
    sc_trace(mVcdFile, acc1_reg_117, "acc1_reg_117");
    ...
    sc_trace(mVcdFile, tmp_3_reg_234, "tmp_3_reg_234");
    sc_trace(mVcdFile, acc_fu_195_p2, "acc_fu_195_p2");
    sc_trace(mVcdFile, acc_reg_218, "acc_reg_218");
    sc_trace(mVcdFile, ap_CS_fsm_state3, "ap_CS_fsm_state3");
    sc_trace(mVcdFile, x_read_reg_223, "x_read_reg_223");
    sc_trace(mVcdFile, ap_CS_fsm_state4, "ap_CS_fsm_state4");
    sc_trace(mVcdFile, acc_cast_fu_146_p1, "acc_cast_fu_146_p1");
    sc_trace(mVcdFile, tmp_3_fu_149_p2, "tmp_3_fu_149_p2");
    sc_trace(mVcdFile, ap_reg_pp0_iter1_tmp_3_reg_234, "ap_reg_pp0_iter1_tmp_3_reg_234");
    sc_trace(mVcdFile, i_1_fu_155_p2, "i_1_fu_155_p2");
    sc_trace(mVcdFile, i_1_reg_238, "i_1_reg_238");
    sc_trace(mVcdFile, ap_enable_reg_pp0_iter0, "ap_enable_reg_pp0_iter0");
    sc_trace(mVcdFile, tmp_6_fu_166_p1, "tmp_6_fu_166_p1");
    sc_trace(mVcdFile, tmp_6_reg_248, "tmp_6_reg_248");
    sc_trace(mVcdFile, c_load_reg_258, "c_load_reg_258");
    ...
    sc_trace(mVcdFile, ap_phi_mux_i_phi_fu_131_p4, "ap_phi_mux_i_phi_fu_131_p4");
    sc_trace(mVcdFile, ap_block_pp0_stage0, "ap_block_pp0_stage0");
    sc_trace(mVcdFile, tmp_s_fu_161_p1, "tmp_s_fu_161_p1");
    sc_trace(mVcdFile, ap_CS_fsm_state8, "ap_CS_fsm_state8");
    sc_trace(mVcdFile, grp_fu_209_p3, "grp_fu_209_p3");
    sc_trace(mVcdFile, acc_fu_195_p1, "acc_fu_195_p1");
...
void fir::thread_ap_clk_no_reset_() {
    if ((esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
         ...
         esl_seteq<1,1,1>(ap_const_lv1_0, ap_reg_pp0_iter1_tmp_3_reg_234.read()))) {
        acc1_reg_117 = grp_fu_201_p3.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        acc1_reg_117 = acc_cast_fu_146_p1.read();
    }
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         ...
         esl_seteq<1,1,1>(tmp_3_reg_234.read(), ap_const_lv1_0))) {
        i_reg_127 = i_1_reg_238.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        i_reg_127 = ap_const_lv6_39;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        acc_reg_218 = acc_fu_195_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        ap_reg_pp0_iter1_tmp_3_reg_234 = tmp_3_reg_234.read();
        tmp_3_reg_234 = tmp_3_fu_149_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(tmp_3_reg_234.read(), ap_const_lv1_0))) {
        c_load_reg_258 = c_q0.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, tmp_3_fu_149_p2.read()))) {
        i_1_reg_238 = i_1_fu_155_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) || (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && 
  esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
  esl_seteq<1,1,1>(tmp_3_reg_234.read(), ap_const_lv1_0)))) {
        reg_138 = shift_reg_q0.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_0, tmp_3_fu_149_p2.read()))) {
        tmp_6_reg_248 = tmp_6_fu_166_p1.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        x_read_reg_223 = x.read();
    }
}

void fir::thread_acc_cast_fu_146_p1() {
    acc_cast_fu_146_p1 = esl_sext<37,26>(acc_reg_218.read());
}

void fir::thread_acc_fu_195_p1() {
    acc_fu_195_p1 =  (sc_lv<10>) (ap_const_lv26_3FFFE86);
}
...
void fir::thread_ap_condition_pp0_exit_iter0_state5() {
    if (esl_seteq<1,1,1>(tmp_3_fu_149_p2.read(), ap_const_lv1_1)) {
...
void fir::thread_ap_phi_mux_i_phi_fu_131_p4() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && 
         esl_seteq<1,1,1>(tmp_3_reg_234.read(), ap_const_lv1_0) && 
         esl_seteq<1,1,1>(ap_block_pp0_stage0.read(), ap_const_boolean_0))) {
        ap_phi_mux_i_phi_fu_131_p4 = i_1_reg_238.read();
    } else {
        ap_phi_mux_i_phi_fu_131_p4 = i_reg_127.read();
    }
}
...
void fir::thread_c_address0() {
    c_address0 =  (sc_lv<6>) (tmp_6_fu_166_p1.read());
}
...
void fir::thread_grp_fu_209_p0() {
    grp_fu_209_p0 =  (sc_lv<10>) (ap_const_lv26_3FFFE86);
}

void fir::thread_grp_fu_209_p2() {
    grp_fu_209_p2 = acc1_reg_117.read().range(31-1, 0);
}

void fir::thread_i_1_fu_155_p2() {
    i_1_fu_155_p2 = (!ap_phi_mux_i_phi_fu_131_p4.read().is_01() || !ap_const_lv6_3F.is_01())? sc_lv<6>(): (sc_biguint<6>(ap_phi_mux_i_phi_fu_131_p4.read()) + sc_bigint<6>(ap_const_lv6_3F));
}
...
void fir::thread_shift_reg_address0() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && 
         esl_seteq<1,1,1>(ap_block_pp0_stage0.read(), ap_const_boolean_0))) {
        shift_reg_address0 =  (sc_lv<6>) (tmp_s_fu_161_p1.read());
...
void fir::thread_shift_reg_address1() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
        shift_reg_address1 = ap_const_lv6_0;
                ...
                esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && 
                esl_seteq<1,1,1>(ap_block_pp0_stage0.read(), ap_const_boolean_0))) {
        shift_reg_address1 =  (sc_lv<6>) (tmp_6_reg_248.read());
    } else {
...
void fir::thread_shift_reg_d1() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
        shift_reg_d1 = x_read_reg_223.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
                esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && 
                esl_seteq<1,1,1>(ap_block_pp0_stage0.read(), ap_const_boolean_0))) {
...
void fir::thread_tmp_3_fu_149_p2() {
    tmp_3_fu_149_p2 = (!ap_phi_mux_i_phi_fu_131_p4.read().is_01() || !ap_const_lv6_0.is_01())? sc_lv<1>(): sc_lv<1>(ap_phi_mux_i_phi_fu_131_p4.read() == ap_const_lv6_0);
}

void fir::thread_tmp_6_fu_166_p1() {
    tmp_6_fu_166_p1 = esl_zext<64,6>(ap_phi_mux_i_phi_fu_131_p4.read());
}

void fir::thread_tmp_s_fu_161_p1() {
    tmp_s_fu_161_p1 = esl_zext<64,6>(i_1_fu_155_p2.read());
}

void fir::thread_y() {
    y = grp_fu_209_p3.read().range(30, 15);
}
