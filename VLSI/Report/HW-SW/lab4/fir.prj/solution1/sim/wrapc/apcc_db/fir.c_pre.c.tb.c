...
printf("\n = 0x%I64X\n", llvm_cbe_tmp__6);
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = getelementptr inbounds [58 x i16]* @aesl_internal_fir.shift_reg, i64 0, i64 %%7, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_24_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = load i16* %%8, align 2, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_25_count);
  llvm_cbe_tmp__8 = (unsigned short )*llvm_cbe_tmp__7;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__8);
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = sext i16 %%9 to i38, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_26_count);
  llvm_cbe_tmp__9 = (unsigned long long )((signed long long )(signed short )llvm_cbe_tmp__8);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = sext i32 %%storemerge1 to i64, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_27_count);
  llvm_cbe_tmp__10 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = getelementptr inbounds [59 x i16]* @aesl_internal_fir.c, i64 0, i64 %%11, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_28_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = load i16* %%12, align 2, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_29_count);
  llvm_cbe_tmp__12 = (unsigned short )*llvm_cbe_tmp__11;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = sext i16 %%13 to i38, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_30_count);
  llvm_cbe_tmp__13 = (unsigned long long )((signed long long )(signed short )llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__13);
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = mul nsw i38 %%14, %%10, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_31_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = add nsw i38 %%15, %%5, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_32_count);
...
printf("\nx = 0x%X\n", llvm_cbe_x);
if (AESL_DEBUG_TRACE)
printf("\n  %%23 = lshr i38 %%22, 15, !dbg !4 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_56_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%24 = trunc i38 %%23 to i16, !dbg !4 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_57_count);
  llvm_cbe_tmp__21 = (unsigned short )((unsigned short )llvm_cbe_tmp__20&65535U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__21);
if (AESL_DEBUG_TRACE)
printf("\n  store i16 %%24, i16* %%y, align 2, !dbg !4 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_58_count);
